  ...
  return (
    <form action={formAction}>
      ...
      <select
        ...
        disabled={pending}
        className={`rounded px-3 py-1 text-xs font-medium ${colors.bg} ${colors.text} border-0 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white`}
      >
        {STATUSES.map((s) => (
