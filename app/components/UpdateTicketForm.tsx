  ...
  return (
    <form action={action} className="flex flex-col gap-3">
      ...
      <select
        ...
        name="status"
        defaultValue={status}
        className="rounded border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-black dark:focus:border-white focus:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      >
        {STATUSES.map((s) => (
